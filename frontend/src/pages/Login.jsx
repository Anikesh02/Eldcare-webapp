  ...
  return  <section className="px-5 lg:px-0">
    <div className="w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10">
      ...
      <form className='py-4 md:py-0' onSubmit={handleSubmit}>
        ...
        <div className="mt-7">
          <button type='submit' className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3" ><Loader onClick={handleButtonClick}isLoading={isLoading} buttonText="Login"/></button>
        </div>
